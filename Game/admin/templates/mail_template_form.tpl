...
<ul class="snav">
	...
	<li><a href="?cat=mail_templates&amp;action=edit&amp;id={$t.id}" class="sel"><img src="interface/icons/edit.gif" alt="edit" align="absmiddle" /> edit template</a></li>
</ul>
...
<fieldset>
      ...
      <tr>
            ...
            <td rowspan="3" valign="top">
                <iframe src="?cat=mail_templates&action=preview&id={$t.id}" width="100%" height="450">
