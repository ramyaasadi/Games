...
function CheckAuthentication()
{
	...
	session_start();
	if (isset($_SESSION['admin']['id']) && is_numeric($_SESSION['admin']['id']) && $_SESSION['admin']['id'] > 0) return true;
	return false;
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'claimcompass.com';
$config['LicenseKey'] = '22AS-B4NR-QRH9-NYJK-DVNA-NDDL-D5Y9';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,jrxml,jasper',
		'deniedExtensions' => '');
